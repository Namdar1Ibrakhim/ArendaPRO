...
public class AuthentificationController {
    ...
    private final GeocodeClient geoсoderExample;
    ...
    public ResponseEntity<GeocodeResponse> geocoderResponseResponseEntity() throws UnsupportedEncodingException, URISyntaxException {
        ...
        GeocodeResponse geocodeResponse = geoсoderExample.geocode(apiKey, location, "json");
        log.info("Кодировка" + geocodeResponse.toString());
        return ResponseEntity.ok(geoсoderExample.geocode(apiKey, location, "json"));
    }
